module.exports = {
  ...
  ar: {
    0: {
      a: 'معلومات عامة',
      b: 'أساسيات تطبيقات الويب',
    },
    1: {
      a: 'مقدمة إلى React',
      b: 'جافاسكريبت',
      c: 'حالة المكون ومعالجة الأحداث',
      d: 'حالة أكثر تعقيداً وتصحيح أخطاء React',
    },
    2: {
      a: 'تصيير المجموعات والوحدات',
      b: 'النماذج',
      c: 'جلب البيانات من الخادم',
      d: 'تعديل البيانات في الخادم',
      e: 'إضافة التنسيقات إلى تطبيق React',
    },
    3: {
      a: 'Node.js و Express',
      b: 'نشر التطبيق على الإنترنت',
      c: 'حفظ البيانات في قاعدة بيانات MongoDB',
      d: 'التحقق من صحة البيانات و ESLint',
    },
    4: {
      a: 'هيكلية التطبيق وأساسيات الاختبار',
      b: 'اختبار الواجهة الخلفية',
      c: 'إدارة المستخدمين',
      d: 'المصادقة باستخدام الرموز المميزة (Token)',
    },
    5: {
      a: 'تسجيل الدخول في الواجهة الأمامية',
      b: 'خاصية props.children والمراجع (refs)',
      c: 'اختبار تطبيقات React',
      d: 'اختبار شامل من البداية للنهاية (E2E)',
      e: 'React Router ومكتبات التنسيق',
    },
    6: {
      a: 'معمارية Flux و Zustand',
      b: 'حالة معقدة، fetch والاختبار',
      c: 'React Query و Context API',
      d: 'Redux (النسخة السابقة)',
    },
    7: {
      a: 'React Router',
      b: 'الخطافات المخصصة (Custom Hooks)',
      c: 'تنسيق التطبيق',
      d: 'esbuild و Webpack',
      e: 'المكونات المعتمدة على الفئات والموضوعات المتنوعة',
      f: 'تمارين: توسيع قائمة المدونات',
    },
    8: {
      a: 'خادم GraphQL',
      b: 'React و GraphQL',
      c: 'قاعدة البيانات وإدارة المستخدمين',
      d: 'تسجيل الدخول وتحديث التخزين المؤقت',
      e: 'الأجزاء والاشتراكات (Fragments & Subscriptions)',
    },
    9: {
      a: 'المقدمة والخلفية العامة',
      b: 'الخطوات الأولى مع TypeScript',
      c: 'كتابة أنواع لتطبيق Express',
      d: 'React مع الأنواع',
    },
    10: {
      a: 'مقدمة إلى React Native',
      b: 'أساسيات React Native',
      c: 'التواصل مع الخادم',
      d: 'اختبار وتوسيع التطبيق',
    },
    11: {
      a: 'مقدمة إلى CI/CD',
      b: 'البدء مع GitHub Actions',
      c: 'النشر (Deployment)',
      d: 'المحافظة على نظافة الكود والبيئة',
      e: 'توسيع الإمكانيات',
    },
    12: {
      a: 'مقدمة إلى الحاويات (Containers)',
      b: 'بناء وتكوين البيئات',
      c: 'أساسيات إدارة الحاويات (Orchestration)',
    },
    13: {
      a: 'استخدام قواعد البيانات العلائقية مع Sequelize',
      b: 'جداول الربط والاستعلامات',
      c: 'الترحيل والعلاقات متعدد لمتعدد',
    },
    14: {
      a: 'موضوعات متقدمة في CI/CD',
    },
  },
};
